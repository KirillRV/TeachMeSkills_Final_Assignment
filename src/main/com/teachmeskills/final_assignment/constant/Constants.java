...
public interface Constants {
    ...
    String PATH_TO_STATISTICS = "statistics/";
    String ERROR_LOGGER_FILE_PATH = "logs/";
    String INFO_LOGGER_FILE_PATH = "logs/";
